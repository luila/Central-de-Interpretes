...
<body>
    <main>                      
        <form id='susLibrasForm1' method='post' action="<?php echo site_url('Main/submitSusLibras1')?>"  class='section'>
                    ...
                    <div class="row center">
                        ...
                        <div class="row center">
                            <div class="input-field col s12">    
                                ...
                                <!--
                                <a href="<?php echo site_url('Main/susLibras2?lang=' . $_SESSION['lang'])?>" class="modal-action modal-close btn grey darken-1 right">
                                    <?php echo $lang['next'];?>
                                </a> -->
